...
VALUES
    (1, 2, 'Это отличное событие!', NOW(), NOW()),
    (2, 2, 'Мне было так весело!', NOW(), NOW()),
    (3, 1, 'Это событие могло быть лучше', NOW(), NOW()),
    (1, 3, 'С нетерпением жду следующего!', NOW(), NOW()),
    (4, 4, 'Это был мой первый визит, и я был впечатлен!', NOW(), NOW()),
    (2, 3, 'Я думаю, что место было идеальным', NOW(), NOW()),
    (5, 1, 'Еда была восхитительной!', NOW(), NOW()),
    (1, 5, 'Музыка была слишком громкой', NOW(), NOW()),
    (3, 4, 'Мне понравилось оформление!', NOW(), NOW()),
    (2, 1, 'Хотелось бы, чтобы было больше активности', NOW(), NOW()),
    (1, 6, 'Организаторы отлично поработали', NOW(), NOW()),
    (4, 3, 'Мне было весело!', NOW(), NOW()),
    (3, 2, 'Я встретил так много новых людей', NOW(), NOW()),
    (1, 4, 'Мероприятие было хорошо организовано', NOW(), NOW()),
    (5, 5, 'Мне показалось, что событие слишком длинное', NOW(), NOW()),
    (2, 6, 'Мне понравились фото с мероприятия!', NOW(), NOW()),
    (3, 5, 'Думаю, на мероприятии могло быть больше сидячих мест', NOW(), NOW()),
    (1, 1, 'Мероприятие было слишком многолюдным, на мой вкус', NOW(), NOW()),
    (4, 2, 'Я прекрасно провел время!', NOW(), NOW()),
    (5, 6, 'Напитки были восхитительны', NOW(), NOW());
